...
class Tacotron2Logger(SummaryWriter):
    ...
    def log_training(self, reduced_loss, d_loss, learning_rate, duration, iteration, embd_loss=None):
        self.add_scalar("training.loss", reduced_loss, iteration)
        self.add_scalar("discriminator_loss", d_loss, iteration)
        self.add_scalar("learning.rate", learning_rate, iteration)
        self.add_scalar("duration", duration, iteration)
        # self.add_scalar('bc_loss', bc_loss, iteration)
        if embd_loss:
            self.add_scalar('embd_loss', embd_loss, iteration)
